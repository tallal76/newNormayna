...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 28 nov. 2022 à 12:35
...
CREATE TABLE `categorie` (
  ...
  `featured_categorie` varchar(10) NOT NULL,
  `active_categorie` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `categorie` (`id_categorie`, `nom_categorie`, `dataFilter_categorie`, `url_categorie`, `featured_categorie`, `active_categorie`) VALUES
(0, 'Tous nos plats', 'AllProduct', '', '', ''),
(1, 'Entrées', 'Entrées', '', '', ''),
(2, 'Plats', 'Plats', '', '', ''),
(3, 'Suppléments', 'Suppléments', '', '', ''),
(4, 'Patisseries', 'Patisseries', '', '', ''),
(5, 'Desserts', 'Desserts', '', '', ''),
(6, 'Boissons', 'Boissons', '', '', '');
...
CREATE TABLE `evenements` (
  ...
  `featured_event` varchar(10) NOT NULL,
  `active_event` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `evenements` (`id_event`, `theme_event`, `adress_event`, `date_event`, `description_event`, `video_event`, `featured_event`, `active_event`) VALUES
...
CREATE TABLE `produits` (
  ...
  `featured_produit` varchar(10) NOT NULL,
  `active_produit` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `produits` (`id_produit`, `titre_produit`, `prix_produit`, `url_produit`, `id_categorie`, `description_produit`, `dataFilter_produit`, `featured_produit`, `active_produit`) VALUES
(1, 'Soupes Chorba ou Harira', 3.5, './assets/images/Soupe-Harira.jpg', 1, '', 'Entrées', '', ''),
(2, 'Brick Viande Hachée', 2.5, './assets/images/Brick-Viande-hachee.jpeg', 1, '', 'Entrées', '', ''),
(3, 'Brick au Thon', 2.5, './assets/images/brick-au-thon.jpeg', 1, '', 'Entrées', '', ''),
(4, 'Mselen Farcie au Viande Hachée', 3, './assets/images/msemen-kefta.jpg', 1, '', 'Entrées', '', ''),
(5, 'Msemen Farcie au Legumes', 2.5, './assets/images/msemen-farci-legume.jpg', 1, '', 'Entrées', '', ''),
(6, 'Salade mechouis', 3.5, './assets/images/salade-mechoui.jpg', 1, '', 'Entrées', '', ''),
(7, 'Salade composée crudités', 3, './assets/images/salade-aux-pates-crudites.jpg', 1, '', 'Entrées', '', ''),
(8, 'Brick Légumes', 2.5, './assets/images/brickaux-legumes.jpeg', 1, '', 'Entrées', '', ''),
(9, 'Brick poulet', 2.5, './assets/images/bricks-au-poulet.jpg', 1, '', 'Entrées', '', ''),
...
(25, 'Msemen', 1.5, './assets/images/Msemen.jpg', 5, 'Galette feuilletée', 'Desserts', '', ''),
(26, 'Baghrir', 1.5, './assets/images/Baghrir.jpg', 5, 'Crêpes milles trous', 'Desserts', '', ''),
...
INSERT INTO `utilisateur` (`id`, `nom`, `prenom`, `username`, `email`, `password`, `role`) VALUES
(1, 'Bouazzi', 'Hamza', 'hamza76', 'hamza@gmail.com', 'azer1', 'user'),
(2, 'Chalal', 'Sonia', 'sony69', 'chalal_sonia@hotmail.fr', '12345', 'user'),
(3, 'Belkasmi', 'Fatna', 'fatna76', 'czsonia2@gmail.com', 'tititoto8', 'admin');
